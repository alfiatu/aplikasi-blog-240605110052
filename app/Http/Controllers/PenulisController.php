    ...
    public function destroy(string $id)
{
    ...
    try {
        // Simpan nama foto terlebih dahulu
        $foto = $penulis->foto;

        // Hapus data penulis dari database
        $penulis->delete();

        // Setelah berhasil menghapus data, hapus file foto jika bukan default
        if ($foto !== 'default.png') {
        ...
        return redirect()
            ...
            ->with(
                'gagal',
                'Penulis tidak dapat dihapus karena masih memiliki artikel.'
            );
    }
}
}